			<div class="row">
					...
					<div class="col-lg-6">
						<section class="panel">
							...
							<i class="fa fa-gg-circle"></i> AUTO ĐĂNG TƯỜNG
							...
							<div class="panel-body">
								<div class="box box-solid box-primary">
									<p align="left">
									<i class="fa fa-lightbulb-o"></i> <b>Auto Đăng Tường</b> Là Gì?<br>
									+ <b>Auto Đăng Tường</b> Là Công Cụ Giúp Bạn Tự Động Đăng Nội Dung Lên Tường Bạn Bè.<br>
									...
									Bước 2: Chọn Bạn Bè Bạn Muốn Đăng Nội Dung Lên Tường Và Ấn Nút Kế Bên Mục Tên Để Chọn. (Ấn Nút Chọn Tất Cả Để Chọn Tất Cả Bạn Bè)<br>
									Bước 3: Nhập Nội Dung Bạn Muốn Đăng.<br>
									Bước 4: Ấn Nút <b>"Đăng Tường"</b> Để Bắt Đầu.
									</p>
								</div><br>
								...
								<div id="hidetool">
									<center><span class="input-group-btn">
										<button type="submit" class="btn btn-primary" onclick="display();">Đăng Tường</button>
									</span></center>
								</div>
								<div id="showtool" style="display: none;">
									<center><span class="input-group-btn">
										<button type="submit" class="btn btn-primary"><i class="fa fa-spinner fa-spin"></i> Đang Đăng Tường</button>
									</span></center>
								</div><br>
<?php
...
?>
								<div class="alert alert-block alert-info fade in"><p align="left"><i class="fa fa-lightbulb-o"></i> Thông Báo Đăng Tường<br>+ Đăng Tường Bạn Bè Thành Công.<br>+ Đã Đăng <?php echo $success; ?> Bạn Bè.</p></div>
<?php
}
?>
							</div>
