				...
				<div class="row">
					<div class="col-lg-5">
						<section class="panel">
							...
							<i class="fa fa-thumbs-o-up"></i> Auto Bình Luận
							...
							<div class="panel-body">
								<div class="box box-solid box-primary">
									<p align="left">
									<i class="fa fa-lightbulb-o"></i> <b>Auto Bình Luận</b> Là Gì?<br>
									+ <b>Auto Bình Luận</b> Là Công Cụ Giúp Tăng Số Lượng Bình Luận Cho Bài Viết Của Bạn Hoặc Tăng Số Lượng Bình Luận Theo ID Bài Viết.<br>
									...
									Bước 2: Chọn Bài Viết Bạn Muốn Tăng Bình Luận Và Ấn Nút <b>"Sao Chép ID"</b>.<br>
									Bước 3: Nhập Nội Dung Bạn Muốn Tăng Bình Luận, Mỗi Dòng 1 Bình Luận Nếu Bạn Muốn Nhiều Bình Luận Khác Nhau.<br>
									Bước 4: Kéo Thanh Số Lượng Bình Luận Đến Mức Thích Hợp Và Ấn Nút <b>"Auto Bình Luận"</b> Để Bắt Đầu.<br>
									<i class="fa fa-lightbulb-o"></i> Lưu Ý<br>
									+ Bài Viết Mà Bạn Muốn Tăng Bình Luận Phải Đặt Ở Chế Độ Công Khai.<br>
								...
								<textarea id="message" class="form-control" placeholder="Nhập Nội Dung Bạn Muốn Tăng Bình Luận, Mỗi Dòng Một Bình Luận..."></textarea><br>
								...
								<center><span class="input-group-btn"><button type="button" class="btn btn-primary" id="auto-comment" onclick="auto_comment();">Auto Bình Luận</button></span></center><br>
								<div id="thongbao"></div>
