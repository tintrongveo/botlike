				...
				<div class="row">
					<div class="col-lg-5">
						<section class="panel">
							...
							<i class="fa fa-thumbs-o-up"></i> Auto Chia Sẻ
							...
							<div class="panel-body">
								<div class="box box-solid box-primary">
									<p align="left">
									<i class="fa fa-lightbulb-o"></i> <b>Auto Chia Sẻ</b> Là Gì?<br>
									+ <b>Auto Chia Sẻ</b> Là Công Cụ Giúp Tăng Số Lượng Chia Sẻ Cho Bài Viết Của Bạn Hoặc Tăng Số Lượng Chia Sẻ Theo ID Bài Viết.<br>
									...
									Bước 2: Chọn Bài Viết Bạn Muốn Tăng Chia Sẻ Và Ấn Nút <b>"Sao Chép ID"</b>.<br>
									Bước 3: Kéo Thanh Số Lượng Chia Sẻ Đến Mức Thích Hợp Và Ấn Nút <b>"Auto Chia Sẻ"</b> Để Bắt Đầu.<br>
									<i class="fa fa-lightbulb-o"></i> Lưu Ý<br>
									+ Bài Viết Mà Bạn Muốn Tăng Chia Sẻ Phải Đặt Ở Chế Độ Công Khai.<br>
								...
								<div class="form-group">
									<label for="name">Số Lượng Chia Sẻ</label>
								...
								<center><span class="input-group-btn"><button type="button" class="btn btn-primary" id="auto-share" onclick="auto_share();">Auto Chia Sẻ</button></span></center><br>
								<div id="thongbao"></div>
